Ext.define('CMDBuildUI.components.grid.plugin.FormInRowWidget', {
    ...
    onItemClick: function (view, record, row, rowIdx, e) {
        ...
        if (!view.getSelectionModel().excludeToggleOnColumn || e.position.colIdx !== view.getSelectionModel().excludeToggleOnColumn) {
            me.toggleRow(rowIdx, record);
        }
    },
    ...
    privates: {
        ...
        toggleRow: function (rowIdx, record) {
            ...
            if (wasCollapsed) {
                ...
                if (me.getRemoveWidgetOnCollapse()) {
