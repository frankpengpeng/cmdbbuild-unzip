Ext.define('CMDBuildUI.components.editor.AceEditorTextarea', {
    ...
    initAceEditor: function () {
        ...
        if (!Ext.isEmpty(me._rowContext)) {
            ...
            // me._rowContext.viewModel.bind({
            //     bindTo: {
            //         record: '{'+me.vmObjectName+'}',
            //         singleItem: '{'+me.theMainObject+'}'
            //     }
            // }, function(data) {
            //     debugger;
            //     if (data.record && data.record.getData()) {
            //         var value = data.record.getData()[me.inputField];
    
            //         me.getAceEditor().getSession().setValue(value);
            //     }
            // });
        ...
        me.getAceEditor().getSession().setMode(me.defaultAceEditorOptions.mode);
