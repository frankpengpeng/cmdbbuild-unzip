Ext.define('CMDBuildUI.util.administration.helper.TabPanelHelper', {
        ...
        try {
            ...
            return view.add({
                ...
                tabConfig: {
                    ...
                    autoEl: {
                        'data-testid': Ext.String.format('administration-tab-{1}', name)
                    },
                    bind: bind || {}
                }
            });
    ...
    onTabChage: function (tabgroup, ctx, view, newtab, oldtab, eOpts) {
        ...
        if(vm.get('actions.add') || vm.get('action') === CMDBuildUI.util.administration.helper.FormHelper.formActions.add){
            vm.set("activeTab", 0);
