Ext.define('CMDBuildUI.view.administration.components.relationsfilters.PanelModel', {
    extend: 'CMDBuildUI.view.filters.relations.PanelModel',
    alias: 'viewmodel.administration-filters-relations-panel',
