            ...
            items: [{
                ...
                columns: [{
                    ...
                    widget: {
                        ...
                        bind: '{record.active}',
                        boxLabel: CMDBuildUI.locales.Locales.administration.classes.properties.form.fieldsets.contextMenus.inputs.status.values.active.label,
                        localized: {
                            boxLabel: 'CMDBuildUI.locales.Locales.administration.classes.properties.form.fieldsets.contextMenus.inputs.status.values.active.label'
                        },
                        readOnly: true
                ...
                items: [{
                    xtype: 'label',
                    flex: 1,
                    text: CMDBuildUI.locales.Locales.administration.classes.strings.createnewcontextaction,
                    localized: {
                        text: 'CMDBuildUI.locales.Locales.administration.classes.strings.createnewcontextaction'
                    },
                    margin: '0 0 10 0',
