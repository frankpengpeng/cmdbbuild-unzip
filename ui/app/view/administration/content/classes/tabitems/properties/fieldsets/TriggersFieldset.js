Ext.define('CMDBuildUI.view.administration.content.classes.tabitems.properties.fieldsets.TriggersFieldset', {
    ...
    items: [{
        ...
        layout: 'column',
        bind: {
            title: Ext.String.format('{0} ({formTriggerCount})', CMDBuildUI.locales.Locales.administration.classes.properties.form.fieldsets.formTriggers.title)
        },
            ...
            items: [{
                ...
                columns: [{
                    ...
                    items: [{
                        ...
                        tooltip: CMDBuildUI.locales.Locales.administration.classes.properties.form.fieldsets.formTriggers.actions.addNewTrigger.tooltip,
                        localized:{
                            tooltip: 'CMDBuildUI.locales.Locales.administration.classes.properties.form.fieldsets.formTriggers.actions.addNewTrigger.tooltip'
                        },
