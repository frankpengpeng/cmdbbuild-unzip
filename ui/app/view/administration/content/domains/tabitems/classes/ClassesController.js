Ext.define('CMDBuildUI.view.administration.content.domains.tabitems.domains.ClassesController', {
    ...
    onBeforeRender: function (view) {
        ...
        this.getViewModel().get('originStore').setRoot(originRoot);
        ...
        var destinationRoot = {
            ...
            enabled: destinationTree.length == 1 ? (destinationTree[0].enabled) ? true : false : undefined
        };
        this.getViewModel().get('destinationStore').setRoot(destinationRoot);
