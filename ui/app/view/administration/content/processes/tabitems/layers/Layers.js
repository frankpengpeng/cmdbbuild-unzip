Ext.define('CMDBuildUI.view.administration.content.processes.tabitems.layers.Layers', {
    extend: 'Ext.grid.Panel',

    requires: [
        'CMDBuildUI.view.administration.content.processes.tabitems.layers.LayersController',
        'CMDBuildUI.view.administration.content.processes.tabitems.layers.LayersModel'
    ],

    alias: 'widget.administration-content-processes-tabitems-layers-layers',
    controller: 'administration-content-processes-tabitems-layers-layers',
    viewModel: {
        type: 'administration-content-processes-tabitems-layers-layers'
    },
    tbar: [{
        xtype: 'button',
        itemId: 'spacer',
