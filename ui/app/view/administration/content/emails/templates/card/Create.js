Ext.define('CMDBuildUI.view.administration.content.emails.templates.card.Create', {
    extend: 'Ext.form.Panel',

    requires: [
        'CMDBuildUI.view.administration.content.emails.templates.card.CreateController',
        'CMDBuildUI.view.administration.content.emails.templates.card.CreateModel'
    ],

    alias: 'widget.administration-content-emails-templates-card-create',
    controller: 'administration-content-emails-templates-card-create',
    viewModel: {
        type: 'administration-content-emails-templates-card-create'
    },
