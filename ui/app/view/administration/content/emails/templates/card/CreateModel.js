Ext.define('CMDBuildUI.view.administration.content.emails.templates.card.CreateModel', {
    extend: 'Ext.app.ViewModel',
    alias: 'viewmodel.administration-content-emails-templates-card-create',
    data: {
        actions: {
            add: true,
            edit: false,
