    ...
    items: [
        ...
        // },
        {
            ...
            items: [{
                ...
                bind: {
                    src: Ext.String.format('{0}/uploads/{theIcon._id}/download?CMDBuild-Authorization={2}', CMDBuildUI.util.Config.baseUrl, CMDBuildUI.util.helper.SessionHelper.getToken())
                }
            }]
        },
        {
