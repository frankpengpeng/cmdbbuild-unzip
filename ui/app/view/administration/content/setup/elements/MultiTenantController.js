Ext.define('CMDBuildUI.view.administration.content.setup.elements.MultiTenantController', {
    ...
    onBeforeRender: function (view) {
        view.up('administration-content').getViewModel().set('title', 'Multitenant');
    ...
    onAfterRender: function (view) {
        setTimeout(function () {
            if (view.up('administration-content-setup-view').getViewModel().get('isMultitenantEnabled') === true) {
                view.up('administration-content-setup-view').down('components-administration-toolbars-formtoolbar').setHidden(true);
            }
        }, 0);
            ...
            store.load({
                callback: function (records, operation, success) {
                    records.forEach(function (_function) {
                        ...
                        var exist = functionList.find(function (obj, i) {
