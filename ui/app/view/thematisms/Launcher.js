Ext.define('CMDBuildUI.view.thematisms.Launcher', {
    ...
    items: [{
        ...
        bind: {
            html: '{appliedthematism.description}',
            hidden: '{!showClearBtn}'
        }
    }, {
        xtype: 'tool',
    ...
    clearThematism: function (skipReload) {
        ...
        vm.set("appliedthematism.description", null);
    },
     ...
     */
    fillThematism: function (values, thematism) {
        for (var attr in values) {
            thematism.set(attr, values[attr]);
        }
    },
                ...
                items: [{
                    ...
                    columns: [{
                        ...
                        items: [{
                            ...
                            handler: function (grid, rowIndex, colIndex) {
                                var record = grid.getStore().getAt(rowIndex);
                                me.getController().deleteThematism(record);
                            }
                        }]
                    }],
