Ext.define('Override.data.ProxyStore', {
    ...
    getAdvancedFilter: function () {
        if (Ext.isEmpty(this._advancedFilter)) {
            this._advancedFilter = new CMDBuildUI.util.AdvancedFilter();
        }
    ...
    /**
     * 
     * @param {CMDBuildUI.util.AdvancedFilter|Object} newvalue 
     */
    setAdvancedFilter: function (newvalue) {
        if (newvalue && newvalue.isAdvancedFilter) {
            this._advancedFilter = newvalue;
        } else if (Ext.isObject(newvalue)) {
            this._advancedFilter = new CMDBuildUI.util.AdvancedFilter(newvalue);
        } else {
    ...
    applyAdvancedFilterBeforeLoad: function () {
        if (this._advancedFilter) {
            var encoded = this._advancedFilter.encode();
