...
public class SimpleAttributeRequestData implements AttributeRequestData {
	...
	private final boolean showInGrid, unique, required, active;
	private final Integer index, precision, scale, length, classOrder;
	private final Map<String, String> metadata;
	private final AttributePermissionMode mode;

	private SimpleAttributeRequestData(SimpleAttributeDataBuilder builder) {
	...
	public static SimpleAttributeDataBuilder copyOf(SimpleAttributeRequestData source) {
		return new SimpleAttributeDataBuilder()
	...
	public static class SimpleAttributeDataBuilder implements Builder<SimpleAttributeRequestData, SimpleAttributeDataBuilder> {
		...
		public SimpleAttributeDataBuilder withLength(Integer length) {
			this.length = length;
			return this;
		}
		...
		@Override
		public SimpleAttributeRequestData build() {
			return new SimpleAttributeRequestData(this);
		}
