...
public class AuditApiImpl extends AbstractServiceClientImpl implements AuditApi {
    ...
    public RequestData getRequestData(String requestId) {
        ...
        return RequestDataImpl.builder()
                ...
                .withPayload(toString(data.get("payload")))
                .withResponse(toString(data.get("response")))
                .withPayloadContentType(toString(data.get("payloadContentType")))
                .withPayloadSize(toInteger(data.get("payloadSize")))
                .withResponseSize(toInteger(data.get("responseSize")))
                ...
                .withErrorMessageDataList(stream(data.get("errors").getAsJsonArray()).map(JsonElement::getAsJsonObject)
