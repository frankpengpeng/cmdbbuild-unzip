...
import static org.cmdbuild.api.fluent.ExistingCardImpl.attachment;
...
public class ExistingCardTest extends AbstractWsFluentApiTest {
    ...
    public void parametersPassedToProxyWhenUpdatingExistingCard() throws Exception {
        ...
        assertThat(wsCard.getId(), equalTo((long) CARD_ID));
    ...
    public void soapCardIsConvertedToFluentApiCardWhenFetchingExistingCard() throws Exception {
        ...
        assertThat(card.getId(), equalTo((long) CARD_ID));
    ...
    public void referenceOrLookupAttributeValueIsReturnedAsStringRepresentationOfInteger() throws Exception {
        ...
        assertThat(card.getAttributes(), hasEntry(ATTRIBUTE_1, (Object) Long.toString(ANOTHER_CARD_ID)));
    }
    ...
    private CardExt soapCardFor(final org.cmdbuild.api.fluent.Card card) {
        final org.cmdbuild.services.soap.client.beans.CardExt soapCard = new org.cmdbuild.services.soap.client.beans.CardExt();
    ...
    private CardExt soapCardWithReference(final String className, final long cardId,
            final String referenceAttributeName, final long referenceId) {
        ...
        card.getAttributeList().add(new Attribute() {
            {
                ...
                setCode(Long.toString(referenceId));
            }
        });
        return card;
    }
