...
import org.cmdbuild.task.reademail.mapper.EngineBasedMapper;
...
import org.cmdbuild.task.reademail.mapper.EngineBasedMapper.Builder;
...
public class EngineBasedMapperTest {
	...
	public void lineFeedHandledCorrectly() throws Exception {
		...
		final String text = EMPTY //
				...
				+ EMPTY;
		final EngineBasedMapper processor = EngineBasedMapper.newInstance() //
				.withText(text) //
