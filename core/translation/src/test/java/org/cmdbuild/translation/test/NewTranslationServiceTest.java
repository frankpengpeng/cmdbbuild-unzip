...
public class NewTranslationServiceTest {
	...
	public void init() {
		...
		when(languageService.getRequestLanguage()).thenReturn("it");
		translationService = new TranslationServiceImpl(mock(ClasseRepository.class), translationRepository, languageService);
	}
