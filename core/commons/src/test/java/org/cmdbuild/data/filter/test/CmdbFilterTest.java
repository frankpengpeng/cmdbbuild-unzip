...
public class CmdbFilterTest {
	...
	public void testParsing() {
		...
		AttributeFilter filter = CmdbFilterUtils.parseFilter(value).getAttributeFilter();
	...
	public void testParsing2() {
		String json = "{ attribute: { simple: { ClassName: 'MyClass',"
				...
				+ "			operator: 'equal',"
				+ "			value:['bar'] } } }";
		AttributeFilter filter = CmdbFilterUtils.parseFilter(json).getAttributeFilter();
		assertTrue(filter.isSimple());
	...
	public void testWriting() {
		...
		String string = CmdbFilterUtils.serializeFilter(filter);
	...
	public void testExportToJSONObject() throws JSONException {
		...
		JSONObject jsono = CmdbFilterUtils.toJsonObject(filter);
