...
public final class GisConfigurationImpl implements GisConfiguration {
    ...
    @ConfigValue(key = "geoserver_url", defaultValue = "http://localhost:8080/geoserver", category = CC_ENV)
    private String geoserverUrl;

    @ConfigValue(key = "geoserver_workspace", defaultValue = "cmdbuild", category = CC_ENV)
    private String geoserverWorkspace;

    @ConfigValue(key = "geoserver_admin_user", defaultValue = "", category = CC_ENV)
    private String geoserverAdminUser;

    @ConfigValue(key = "geoserver_admin_password", defaultValue = "", category = CC_ENV)
