...
//	/**
//	 *
//	 * return false if the session is invalid (for example if the session id is
//	 * invalid, or if the session has expired; note that invalid sessions are
//	 * just object placeholders, all other methods will fail with an exception
//	 * on an invalid session token
//	 *
