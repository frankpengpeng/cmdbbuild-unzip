...
public class QuerySpecsImpl implements QuerySpecs {
	...
	private QuerySpecsImpl(Builder builder) {
	...
	public String toString() {
		return "QuerySpecsImpl{" + "fromClause=" + fromClause + ", joinClauses=" + joinClauses + ", directJoinClauses=" + directJoinClauses + ", offset=" + offset + ", limit=" + limit + ", whereClause=" + whereClause + '}';
	}
