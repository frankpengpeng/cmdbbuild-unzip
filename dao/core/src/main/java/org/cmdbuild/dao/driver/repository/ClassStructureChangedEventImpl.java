...
public class ClassStructureChangedEventImpl implements ClassStructureChangedEvent {

	private final Set<Long> affectedClassOids;

	public ClassStructureChangedEventImpl(Iterable<Long> affectedClassOids) {
