...
BEGIN
	...
	FOR _attr_classe,_attributes IN SELECT classe,attributes FROM _cmdb_patch_aux_1 WHERE topclass = _classe AND groupname = _old
	LOOP
		FOREACH _attribute in ARRAY _attributes
		LOOP
...
BEGIN
	...
	LOOP
		...
		LOOP
			...
			IF _groupname IS NOT NULL AND _groupname <> '' THEN
	...
	LOOP
		...
		ELSE
			...
			ELSE
				...
				_translation_code = 'attributegroup.' || _groupname || '.description';
