...
public class SimpleRequestData implements RequestData {
	...
	private final List<ErrorOrWarningEvent> events;
	...
	private SimpleRequestData(RequestDataBuilder builder) {
		...
		this.events = builder.events != null ? ImmutableList.copyOf(builder.events) : emptyList();
	}
...
//	@CardAttr
	...
	@Override
	public List<ErrorOrWarningEvent> getErrorOrWarningEvents() {
		return events;
	}
	...
	public static RequestDataBuilder copyOf(RequestData data) {
		return new RequestDataBuilder().
				...
				withErrorsAndWarningEvents(data.getErrorOrWarningEvents())
	...
	public static class RequestDataBuilder implements Builder<SimpleRequestData, RequestDataBuilder> {
		...
		private List<ErrorOrWarningEvent> events;
		protected String sessionId, requestId, trackingId, actionId, user, path, method, query, soapActionOrMethod;
...
//		}
		...
		public RequestDataBuilder withMethod(String method) {
		...
		public RequestDataBuilder withTimestamp(DateTime timestamp) {
			this.timestamp = checkNotNull(timestamp);
			return this;
		}

		public RequestDataBuilder withErrorsAndWarningEvents(@Nullable List<ErrorOrWarningEvent> events) {
			this.events = events;
			return this;
		}
