...
public class DomainRepositoryImpl implements DomainRepository {
    ...
    public DomainRepositoryImpl(CacheService cacheService, @Qualifier(SYSTEM_LEVEL_ONE) JdbcTemplate jdbcTemplate, InnerAttributeRepository attributesRepository, ClasseRepository classRepository, DaoEventService eventService) {
        ...
        eventService.getEventBus().register(new Object() {
            ...
            public void handleAttributeModifiedEvent(AttributesModifiedEvent event) {
                if (event.getOwner().isDomain()) {
                    invalidateOurCache();
                    eventService.post(DomainStructureChangedEvent.affecting(event.getOwner().getId()));
                }
            }
            ...
            public void handleAttributeGroupModifiedEvent(AttributeGroupModifiedEvent event) {
                invalidateOurCache();
                eventService.post(DomainStructureChangedEvent.affectingAll());//TODO check this
            }
        });
    }
    ...
    Domain getDomainOrNull(@Nullable String domainId) {
        if (isBlank(domainId)) {
            ...
            return DomainImpl.builder()//TODO root domain, check this
                    ...
                    .withClass1(classRepository.getRootClass())
    ...
    public Domain createDomain(DomainDefinition definition) {
        ...
        eventService.post(new DomainCreatedEventImpl(domain));
        return domain;
    }
    ...
    public Domain updateDomain(DomainDefinition definition) {
        ...
        invalidateOurCache();
        Domain domain = getDomain(definition.getName());
        eventService.post(DomainStructureChangedEvent.affecting(domain.getId()));
        return domain;
    }
    ...
    public void deleteDomain(Domain domain) {
        ...
        invalidateOurCache();
        eventService.post(DomainStructureChangedEvent.affecting(domain.getId()));//TODO check this
    }
