...
public class CommentUtils {
    ...
    public final static BiMap<String, String> ENTRY_TYPE_COMMENT_TO_METADATA_MAPPING = ImmutableBiMap.copyOf(map(
            ...
            COMMENT_MODE, ENTRY_TYPE_MODE));

    public final static BiMap<String, String> CLASS_COMMENT_TO_METADATA_MAPPING = ImmutableBiMap.copyOf(map(ENTRY_TYPE_COMMENT_TO_METADATA_MAPPING).with(
    ...
    public final static BiMap<String, String> ATTRIBUTE_COMMENT_TO_METADATA_MAPPING = ImmutableBiMap.copyOf(map(ENTRY_TYPE_COMMENT_TO_METADATA_MAPPING).with(
            COMMENT_DESCR, EntryTypeMetadata.DESCRIPTION,
    ...
    public static Map<String, String> parseCommentFromFeatures(Map<String, String> features, Map<String, String> mapping) {
        return features.entrySet().stream().map((e) -> {
            if (!mapping.containsKey(e.getKey()) || equal(mapping.get(e.getKey()), COMMENT_IGNORED)) {
                return null;
            } else {
