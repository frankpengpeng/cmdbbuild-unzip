...
public class FkDomainRepositoryImpl implements FkDomainRepository {
    ...
    public FkDomainRepositoryImpl(ClasseRepository classeRepository, CacheService cacheService, DaoEventService eventService) {
    ...
    private class FkDomainImpl implements FkDomain {
        ...
        public FkDomainImpl(Attribute attribute) {
            ...
            this.isMasterDetail = firstNotNull(attribute.getMetadata().isMasterDetail(), false);
            this.masterDetailDescription = firstNotBlank(attribute.getMetadata().getMasterDetailDescription(), target.getName());
