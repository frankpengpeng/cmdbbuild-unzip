...
public class PatchManagerUtils {
    ...
    private static PatchService buildAndInitPatchManager(DatabaseCreator databaseCreator, File sqlDir) {
        ...
        FunctionCodeRepository functionCodeRepository = new FunctionCodeRepositoryImpl(new File(sqlDir, "functions"), new LocalCacheServiceImpl());
