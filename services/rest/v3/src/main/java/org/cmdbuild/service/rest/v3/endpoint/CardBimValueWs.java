...
public class CardBimValueWs {
    ...
    @GET
    @Path("")
    public Object getAllForCard(@PathParam(CLASS_ID) String classId, @PathParam(CARD_ID) Long cardId, @QueryParam("if_exists") boolean checkIfExists, @QueryParam("include_related") boolean includeRelated) {
