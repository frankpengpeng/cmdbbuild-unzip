...
public class CardAttachmentsWsV2 {
    ...
    @Produces(APPLICATION_JSON)
    public Object create(@PathParam("classId") String classId, @PathParam("cardId") Long cardId, @Multipart(value = ATTACHMENT, required = false) WsAttachmentData attachment,
        ...
        DocumentInfoAndDetail document = documentService.create(classId, cardId, DocumentDataImpl.builder()
                ...
                .build());
        return map("data", serializeAttachment(classId, document));
    }
