...
public class DomainAttributesWsV2 {
    ...
    private final DataView dao;
    private final DaoService daoService;
    private final TranslationService translationService;

    public DomainAttributesWsV2(DataView userDataAccessLogic, DaoService daoService, TranslationService translationService) {
        this.dao = checkNotNull(userDataAccessLogic);
