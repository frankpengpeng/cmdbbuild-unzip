...
public class CardWsV2 {
    ...
    public CardWsV2(UserCardService cardService, DaoService dao, CardFilterService filterService, CardWsSerializationHelper helper) {
    ...
    public Object create(@PathParam("classId") String classId, WsCardData card) {
        return helper.serializeCard(cardService.createCard(classId, card.getValues()));
    }
    ...
    public Object readOne(@PathParam("classId") String classId, @PathParam("cardId") Long id, @QueryParam("includeModel") Boolean includeModel) {
        ...
        //reference, foreignkey -> IdAndDescription.desc
    }
    ...
    public Object update(@PathParam("classId") String classId, @PathParam("cardId") Long id, WsCardData card) {
        return helper.serializeCard(cardService.updateCard(classId, id, card.getValues()));
    }
...
//            this.values = mapClassValues(checkNotNull(values)).immutable(); TODO
    ...
    public CmMapUtils.FluentMap serializeCard(Card card, CardWsSerializationHelper.ExtendedCardOptions... extendedCardOptions) {
