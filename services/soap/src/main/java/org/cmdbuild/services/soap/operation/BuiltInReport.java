...
public enum BuiltInReport {
	...
	LIST("_list") {
		...
		@Override
		public ReportFactoryBuilder<ReportProcessor> newBuilder(final DataView dataView,
...
//	public abstract ReportFactoryBuilder<ReportFactory> newBuilder(DataView dataView, FilesStore filesStore,
	public abstract ReportFactoryBuilder<ReportProcessor> newBuilder(DataView dataView,
