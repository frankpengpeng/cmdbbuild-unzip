...
//	};
	...
	SerializationStuff(final DataView dataView) {
	...
	public AttributeSchema serialize(final Attribute attribute, final int index) {
		...
		attribute.getType().accept(new CMAttributeTypeVisitor() {
			...
			public void visit(final ForeignKeyAttributeType attributeType) {
				...
				final Classe targetClass = dataView.findClasse(attributeType.getForeignKeyDestinationClassName());
			...
			public void visit(final ReferenceAttributeType attributeType) {
				...
				final Domain domain = dataView.findDomain(attributeType.getDomainName());
				if (domain == null) {
