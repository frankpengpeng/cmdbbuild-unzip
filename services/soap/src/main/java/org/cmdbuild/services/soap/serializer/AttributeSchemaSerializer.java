...
public class AttributeSchemaSerializer implements CMAttributeTypeVisitor {
	...
	public static AttributeSchema serialize(final StoredFunctionParameter functionParameter) {
	...
	public void visit(final DecimalAttributeType attributeType) {
		...
		if (attributeType.getPrecision() != null) {
			serialized.setPrecision(attributeType.getScale());
		}
		if (attributeType.getScale() != null) {
			serialized.setScale(attributeType.getScale());
		}
	}
	...
	private void throwIllegalType(final CardAttributeType<?> attributeType) {
