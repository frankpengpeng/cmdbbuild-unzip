...
you shouldn't have to configure anything directly inside <tomcat_home>/webapps/<cmdbuild_webapp_context>
so that the whole webapp could be replaces without having to worry about 
losing some configuration.
