 ...
 */
package org.cmdbuild.workflow.core.xpdl;
...
public class XpdlTaskUtils {
	...
	TaskAttribute taskVariableFromXpdlKeyValue(@Nullable String key, @Nullable String value) {
	...
	public static @Nullable
	TaskMetadata taskMetadataFromXpdlKeyValue(@Nullable String key, @Nullable String value) {
