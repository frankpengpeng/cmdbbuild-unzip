...
public class FlowDataSerializerUtils {
    ...
    public static String serializeRiverFlowData(Map<String, Object> data, Classe classe, RiverPlan plan, RiverFlow.FlowStatus flowStatus) {
    ...
    public static Map<String, Object> deserializeFlowData(@Nullable String data, RiverPlan riverPlan, Predicate<String> keyFilter) {
        if (isBlank(data)) {
            return emptyMap();
        } else {
