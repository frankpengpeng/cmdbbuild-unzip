...
import static org.cmdbuild.workflow.river.utils.ClosedFlowUtils.isDummyTaskIdForClosedFlow;
        ...
        try {
            ...
            Task res = TaskImpl.builder()
                    ...
                    .accept(b -> {
                        switch (mode) {
                            case CM_FULL:
                                b.withTaskWidgetSupplier(new TaskWidgetSupplier(riverFlow::getData, taskDefinition));
                                break;
                            case CM_LEAN:
                    ...
                    .isAdvanceable(operationUser.hasPrivileges(RP_DATA_ALL_WRITE) || operationUser.hasActiveGroupName(taskPerformer))
                    .withCard(flow)
                    .build();
