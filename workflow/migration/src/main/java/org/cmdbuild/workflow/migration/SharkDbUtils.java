...
public class SharkDbUtils {
    ...
    public interface SharkHelper {
        ...
        Pair<String, String> getSharkActivityDefinitionIdWithParent(String sharkActivityId);
    ...
    private static class SharkHelperImpl implements SharkHelper {
        ...
        @Override
        public Pair<String, String> getSharkActivityDefinitionIdWithParent(String sharkActivityId) {
        ...
        public Map<String, Object> getFlowDataForProcess(String sharkProcessCode) {
            return sharkJdbcTemplate.query("SELECT"
                    ...
                    + " FROM shkprocessdata WHERE process = (SELECT objectid FROM shkprocesses WHERE id = ?)", (r, i) -> {
        ...
        private Object convertSharkDbValue(ResultSet r) throws SQLException {
            ...
            switch (type) {
                case 0:
                    return r.getBoolean("variablevaluebool");
                case 1:
                    return r.getLong("variablevaluelong");
                case 2:
                    return r.getDouble("variablevaluedbl");
                case 3:
                    return nullToEmpty(r.getString("variablevaluevchar"));
                case 4:
                    return r.getTimestamp("variablevaluedate");
                case 5:
                    return convertBinarySharkDbValue(r.getBytes("variablevalue"));
                default:
