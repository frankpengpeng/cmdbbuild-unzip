...
import static org.cmdbuild.workflow.river.engine.RiverFlow.FlowStatus.ABORTED;
import static org.cmdbuild.workflow.river.engine.RiverFlow.FlowStatus.RUNNING;
import static org.cmdbuild.workflow.river.engine.RiverFlow.FlowStatus.SUSPENDED;
...
public class RiverFlowServiceImpl implements RiverFlowService {
    ...
    public RiverFlowServiceImpl(RiverPlanRepository planRepository, RiverFlowRepository flowRepository, RiverTaskService taskService) {
    ...
    public RiverFlow createFlow(RiverPlan riverPlan) {
        ...
        RiverFlow flow = RiverFlowImpl.builder()
                ...
                .withPlan(riverPlan)
                .withTasks(emptyList())
                .withFlowStatus(RiverFlow.FlowStatus.READY)
    ...
    public RiverFlow terminateFlow(RiverFlow flow) {
        return RiverFlowImpl.copyOf(flow).withFlowStatus(ABORTED).build();
    }
