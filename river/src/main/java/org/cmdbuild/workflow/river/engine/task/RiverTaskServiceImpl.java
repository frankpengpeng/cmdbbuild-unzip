...
public class RiverTaskServiceImpl implements RiverTaskService {
    ...
    public RiverTaskServiceImpl(TaskClassLoaderSupplier taskClassLoaderSupplier) {
        taskScriptExecutorService = new TaskScriptExecutorServiceImpl(new GroovyScriptServiceImpl(), taskClassLoaderSupplier);
    }
