...
public class SoapUtilsTest {
    ...
    @Test
    public void testSoapResponseParsing() {

        SoapResponse soapResponse = new SoapResponseImpl(payload, emptyMap());
        ...
        soapResponse = new SoapResponseImpl(payload, map("test", "http://test.com"));
