...
public class WidgetUtils {
    ...
    public static WidgetData toWidgetData(String ownerInfoStr, String widgetType, String serializedWidgetData) {
        return toWidgetData(ownerInfoStr, widgetType, true, serializedWidgetData, emptyMap());
    }

    public static WidgetData toWidgetData(String widgetType, boolean isActive, String serializedWidgetData, String label) {
    ...
    public static WidgetData toWidgetData(String ownerInfoStr, String widgetType, boolean isActive, String serializedWidgetData, Map<String, String> extraData) {
        ...
        String id = nullToEmpty(ownerInfoStr) + hash(widgetType + serializedWidgetData);//TODO normalize owner info str
    ...
    public static boolean isWorwflowWidgetType(String key) {
